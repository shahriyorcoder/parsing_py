...
# print(reader.pages[0].extract_text().find('Pasport') )
...
# print(reader.pages[0].extract_text()[reader.pages[0].extract_text().find("Test topshirish fanlari"):reader.pages[0].extract_text().find("Test sinovi topshirish hududi va hududga kelish vaqti")] )
